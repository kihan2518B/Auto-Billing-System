...
export default function OrganizationForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!name || !gstNumber || !address || !bankName || !accountNumber || !ifscCode || !logo) {
      ...
      const { publicUrl, error: uploadError } = await UploadFile(logo, 'images', 'images');
      if (uploadError) {
      ...
      <DialogContent className="sm:max-w-[600px] w-[95vw] max-h-[90vh] overflow-y-auto bg-neutral-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <Label htmlFor="name" className="text-neutral-text text-sm font-medium mb-1">
                Organization Name
              </Label>
              <Input
                type="text"
            ...
            <div>
              <Label htmlFor="gstNumber" className="text-neutral-text text-sm font-medium mb-1">
                GST Number
              </Label>
              <Input
                type="text"
            ...
            <div className="sm:col-span-2">
              <Label htmlFor="address" className="text-neutral-text text-sm font-medium mb-1">
                Address
              </Label>
              <Input
                type="text"
            ...
            <div>
              <Label htmlFor="bank-name" className="text-neutral-text text-sm font-medium mb-1">
                Bank Name
              </Label>
              <Input
                type="text"
            ...
            <div>
              <Label htmlFor="bank-account-number" className="text-neutral-text text-sm font-medium mb-1">
                Account Number
              </Label>
              <Input
                type="text"
            ...
            <div>
              <Label htmlFor="ifsc" className="text-neutral-text text-sm font-medium mb-1">
                IFSC Code
              </Label>
              <Input
                type="text"
            ...
            <div className="sm:col-span-2">
              <Label htmlFor="logo" className="text-neutral-text text-sm font-medium mb-1">
                Company Logo
              </Label>
