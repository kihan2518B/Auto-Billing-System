...
export async function POST(request: Request) {
  ...
  const { customerId, organizationId, items, totalAmount, gstAmount, grandTotal, vehicalNumber, invoiceType } = body
  ...
  try {
    ...
    return NextResponse.json({ message: "Invoice created successfully", invoice, outputPath }, {
      status: 201
    })
